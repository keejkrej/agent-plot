...
>()("agent-plot/desktop/ShellEnvironment") {}
...
const startMarker = (name: string) => `__AGENT_PLOT_ENV_${name}_START__`;
const endMarker = (name: string) => `__AGENT_PLOT_ENV_${name}_END__`;
