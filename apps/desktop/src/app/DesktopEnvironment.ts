...
>()("agent-plot/desktop/Environment") {}

const APP_BASE_NAME = "Agent Plot";
...
const makeDesktopEnvironment = Effect.fn("desktop.environment.make")(function* (
  ...
  const baseDir = Option.getOrElse(config.agentPlotHome, () => path.join(homeDirectory, ".agent-plot"));
  ...
  const userDataDirName = isDevelopment ? "agent-plot-dev" : "agent-plot";
  const legacyUserDataDirName = isDevelopment ? "Agent Plot (Dev)" : "Agent Plot (Alpha)";
  ...
  return DesktopEnvironment.of({
    ...
    branding,
    displayName,
    appUserModelId: isDevelopment ? "com.agentplot.desktop.dev" : "com.agentplot.desktop",
    linuxDesktopEntryName: isDevelopment ? "agent-plot-dev.desktop" : "agent-plot.desktop",
    linuxWmClass: isDevelopment ? "agent-plot-dev" : "agent-plot",
    userDataDirName,
