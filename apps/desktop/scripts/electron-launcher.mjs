// This file mostly exists because we want dev mode to say "Agent Plot (Dev)" instead of "electron"
...
const APP_DISPLAY_NAME = isDevelopment ? "Agent Plot (Dev)" : "Agent Plot (Alpha)";
const APP_BUNDLE_ID = isDevelopment ? "com.agentplot.desktop.dev" : "com.agentplot.desktop";
