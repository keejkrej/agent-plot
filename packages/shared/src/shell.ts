...
const PATH_CAPTURE_START = "__AGENT_PLOT_PATH_START__";
const PATH_CAPTURE_END = "__AGENT_PLOT_PATH_END__";
...
function envCaptureStart(name: string): string {
  return `__AGENT_PLOT_ENV_${name}_START__`;
}

function envCaptureEnd(name: string): string {
  return `__AGENT_PLOT_ENV_${name}_END__`;
}
