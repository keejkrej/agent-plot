...
import type { DesktopUpdateState } from "@agent-plot/contracts/desktop";
    ...
    Layer.provide(
      Layer.mergeAll(
        ...
        DesktopConfig.layerTest({
          AGENT_PLOT_HOME: `/tmp/t3-desktop-updates-test-${process.pid}`,
          AGENT_PLOT_DESKTOP_MOCK_UPDATES: "true",
          AGENT_PLOT_DESKTOP_MOCK_UPDATE_SERVER_PORT: "4141",
          ...options.env,
        }),
      ),
    ),
