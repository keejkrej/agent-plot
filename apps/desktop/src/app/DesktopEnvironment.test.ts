  ...
  it.effect("derives state paths and development identity inside Effect", () =>
    Effect.gen(function* () {
      const environment = yield* makeEnvironment(
        {},
        {
          AGENT_PLOT_HOME: " /tmp/t3 ",
          AGENT_PLOT_COMMIT_HASH: " 0123456789abcdef ",
          AGENT_PLOT_PORT: "4949",
          VITE_DEV_SERVER_URL: "http://localhost:5173",
          AGENT_PLOT_DEV_REMOTE_T3_SERVER_ENTRY_PATH: " /remote/server.mjs ",
          AGENT_PLOT_OTLP_TRACES_URL: " http://127.0.0.1:4318/v1/traces ",
          AGENT_PLOT_OTLP_EXPORT_INTERVAL_MS: "2500",
        },
      );
      ...
      assert.equal(environment.appUserModelId, "com.agentplot.desktop.dev");
      assert.equal(environment.linuxWmClass, "agent-plot-dev");
      assert.deepEqual(
