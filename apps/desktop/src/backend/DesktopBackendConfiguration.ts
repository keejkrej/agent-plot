import { parsePersistedServerObservabilitySettings } from "@agent-plot/shared/serverSettings";
...
>()("agent-plot/desktop/BackendConfiguration") {}
...
const DESKTOP_BACKEND_ENV_NAMES = [
  "AGENT_PLOT_PORT",
  "AGENT_PLOT_MODE",
  "AGENT_PLOT_NO_BROWSER",
  "AGENT_PLOT_HOST",
  "AGENT_PLOT_DESKTOP_WS_URL",
  "AGENT_PLOT_DESKTOP_LAN_ACCESS",
  "AGENT_PLOT_DESKTOP_LAN_HOST",
  "AGENT_PLOT_DESKTOP_HTTPS_ENDPOINTS",
  "AGENT_PLOT_TAILSCALE_SERVE",
  "AGENT_PLOT_TAILSCALE_SERVE_PORT",
] as const;
  ...
  > {
    ...
    return {
      ...
      bootstrap: {
        ...
        agentPlotHome: environment.baseDir,
