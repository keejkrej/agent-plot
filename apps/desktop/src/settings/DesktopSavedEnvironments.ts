import { EnvironmentId, type PersistedSavedEnvironmentRecord } from "@agent-plot/contracts/desktop";
import { fromLenientJson } from "@agent-plot/shared/schemaJson";
...
>()("agent-plot/desktop/SavedEnvironments") {}
